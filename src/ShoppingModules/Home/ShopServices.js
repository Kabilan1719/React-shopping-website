...
const ShopServices = () => {
  return (
    <div className='Serices-box'>
        <div className='row row2'>
            <div className='services-card col-lg-3'>
                <div className='service-card-img'>
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="21 41.657 157.001 114.861" viewBox="21 41.657 157.001 114.861" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-km3aq0p4 svg [data-color="1"] #comp-km3aq0p4 svg [data-color="2"]</style></defs><g>
                ...
                <div className='service-card-text'>
                    <h2>Cube-side pickup</h2>
                </div>
            </div>
            <div className='services-card col-lg-3'>
                <div className='service-card-img'>
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="22 29.01 158 141.964" viewBox="22 29.01 158 141.964" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-km3c06wy svg [data-color="1"] #comp-km3c06wy svg [data-color="2"] </style></defs><g>
                    ...
                    <path d="M147.434 68.5h-.041a2.778 2.778 0 0 1-1.956-.846l-7.506-7.747a2.781 2.781 0 0 1 3.994-3.87l5.568 5.746 13.928-13.551a2.781 2.781 0 0 1 3.878 3.986l-15.925 15.494a2.781 2.781 0 0 1-1.94.788z" fill="#621FCC" data-color="2"></path></g>
                    </svg>
                </div>
                <div className='service-card-text'>
            ...
            <div className='services-card col-lg-3'>
                <div className='service-card-img'>
                    ...
                    <path d="M96.465 129.355c-8.196 0-14.864-6.668-14.864-14.864s6.668-14.864 14.864-14.864 14.864 6.668 14.864 14.864-6.668 14.864-14.864 14.864zm0-23.728c-4.887 0-8.864 3.977-8.864 8.864s3.977 8.864 8.864 8.864 8.864-3.977 8.864-8.864-3.977-8.864-8.864-8.864z" fill="#621FCC" data-color="2"></path></g>
                    </svg>
                </div>
                <div className='service-card-text'>
                    <h2>Low prices guaranteed</h2>
                </div>
            </div>
            <div className='services-card col-lg-3'>
                <div className='service-card-img'>
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="18.037 24.249 169.427 148.092" viewBox="18.037 24.249 169.427 148.092" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-km3aq0qx svg [data-color="1"] #comp-km3aq0qx svg [data-color="2"]</style></defs><g>
                    ...
                    <path d="M98 124c-.5 0-1.1-.1-1.6-.3-1.5-.6-2.4-2.1-2.4-3.7V51.9c0-2.2 1.8-4 4-4s4 1.8 4 4v58.8l25.8-24.6c1.6-1.5 4.1-1.5 5.7.1 1.5 1.6 1.5 4.1-.1 5.7l-32.5 31c-.9.8-1.9 1.1-2.9 1.1z" fill="#621fcc" data-color="2"></path></g>
                    </svg>
                </div>
                <div className='service-card-text'>
                    <h2>Available to you 24/7</h2>
                </div>
            </div>
        </div>
    </div>
